...
```
python3 politician.py
```

You will then be asked a start middle and end state. For the start and end prompt, enter the two letter abreviation of your beginning and end destinations. For the middle, enter all of your middle states as the two letter abreviations of each state with no spaces. Below is an example:
